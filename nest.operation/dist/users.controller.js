...
let UserController = class UserController {
    ...
    async getVideos(res, params, query, headers) {
        try {
    ...
    async addVideo(reqData, req, res) {
        try {
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "getVideos", null);
__decorate([
    (0, common_1.Post)('/addvideo'),
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "addVideo", null);
